SYSTEM_PROMPT = (
    ...
    "say so clearly.\n\n"
    "RESPONSE FORMAT: Always answer in clear, natural language prose. "
    "Never output raw JSON, Python dicts, or structured data as your response — "
    "not even embedded in a sentence. Never use dict syntax like "
    "{'key': 'value'} or [{'key': 'value'}]. "
    "When the data contains a list of objects (e.g. payment fees, charges, line items), "
    "present each item as a separate markdown bullet point with field names in plain "
    "English, for example:\n"
    "- Card Network: Visa; Fee Type: Transaction Fee; Fee Structure: 1.5% + $0.10\n"
    "- Card Network: Mastercard; Fee Type: Interchange; Fee Structure: Pass Through\n\n"
