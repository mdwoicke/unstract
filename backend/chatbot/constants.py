SYSTEM_PROMPT = (
    ...
    "- Only quote text that actually appears in the provided document "
    "sections (EXTRACTED DATA or ORIGINAL DOCUMENT TEXT).\n"
    ...
    "multiple citations.\n"
    "- If no exact quote is available, do not use a citation."
)
